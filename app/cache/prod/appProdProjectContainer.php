...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_daee2a80b374f31208cc9ae13777459b2f08f290205f03a2f1623be35ff1b745');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $s = new \Symfony\Component\HttpFoundation\RequestMatcher('^/reporteAsistencia');
        ...
        $t->add($j, array(0 => 'ROLE_USER'), NULL);
        ...
        $t->add($r, array(0 => 'ROLE_SUPER_SUPER_ADMIN'), NULL);
        $t->add($s, array(0 => 'ROLE_USER'), NULL);

        $u = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $v = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $u, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($u, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout'));
