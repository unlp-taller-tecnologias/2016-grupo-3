 ...
 */
class Habilitados extends \AppBundle\Entity\Habilitados implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Habilitados' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Habilitados' . "\0" . 'apellido', '' . "\0" . 'AppBundle\\Entity\\Habilitados' . "\0" . 'dni', '' . "\0" . 'AppBundle\\Entity\\Habilitados' . "\0" . 'legajo', '' . "\0" . 'AppBundle\\Entity\\Habilitados' . "\0" . 'idcurso');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Habilitados $proxy) {
