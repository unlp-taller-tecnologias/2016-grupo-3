...
class AlumnosParcial extends \AppBundle\Entity\AlumnosParcial implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'observacion', 'nota', '' . "\0" . 'AppBundle\\Entity\\AlumnosParcial' . "\0" . 'estado', '' . "\0" . 'AppBundle\\Entity\\AlumnosParcial' . "\0" . 'condicion', 'alumnos', 'parciales');
        }
