 ...
 */
class UserCatedra extends \AppBundle\Entity\UserCatedra implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\UserCatedra' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\UserCatedra' . "\0" . 'iduser', '' . "\0" . 'AppBundle\\Entity\\UserCatedra' . "\0" . 'idcatedra');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserCatedra $proxy) {
