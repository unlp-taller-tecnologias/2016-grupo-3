...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'catedra', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'apellido', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'dni', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'cargo', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function setCatedra(\AppBundle\Entity\Catedras $catedra = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCatedra', array($catedra));

        return parent::setCatedra($catedra);
    }
    ...
    public function getCatedra()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCatedra', array());

        return parent::getCatedra();
    }
    ...
    public function addCursada(\AppBundle\Entity\Cursos $cursadas)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addCursada', array($cursadas));

        return parent::addCursada($cursadas);
    }
    ...
    public function removeCursada(\AppBundle\Entity\Cursos $cursadas)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeCursada', array($cursadas));

        return parent::removeCursada($cursadas);
    }
    ...
    public function getCursadas()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCursadas', array());
