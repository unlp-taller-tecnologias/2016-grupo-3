 ...
 */
class Catedras extends \AppBundle\Entity\Catedras implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Catedras' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Catedras' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Catedras' . "\0" . 'borrado', 'usuarios');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Catedras $proxy) {
    ...
    public function setSecretario(\AppBundle\Entity\User $secretario)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSecretario', array($secretario));

        return parent::setSecretario($secretario);
    }
    ...
    public function getSecretario()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSecretario', array());

        return parent::getSecretario();
    }
