 ...
 */
class Clase extends \AppBundle\Entity\Clase implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nombre', 'descripcion', 'requerida', 'fechaInicio', 'fechaFin', '' . "\0" . 'AppBundle\\Entity\\Clase' . "\0" . 'estado', 'alumnos', 'cursada');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Clase $proxy) {
    ...
    public function setRequerida($requerida)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRequerida', array($requerida));

        return parent::setRequerida($requerida);
    }
    ...
    public function getRequerida()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRequerida', array());

        return parent::getRequerida();
    }
    ...
    public function setCursada(\AppBundle\Entity\Cursos $cursada = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCursada', array($cursada));

        return parent::setCursada($cursada);
    }
    ...
    public function getCursada()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCursada', array());
