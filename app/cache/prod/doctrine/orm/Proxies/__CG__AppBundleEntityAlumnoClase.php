 ...
 */
class AlumnoClase extends \AppBundle\Entity\AlumnoClase implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'observacion', '' . "\0" . 'AppBundle\\Entity\\AlumnoClase' . "\0" . 'estado', 'alumnos', 'clases');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AlumnoClase $proxy) {
    ...
    public function setClases(\AppBundle\Entity\Clase $clases = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setClases', array($clases));
