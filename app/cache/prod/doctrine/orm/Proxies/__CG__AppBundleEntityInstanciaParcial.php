 ...
 */
class InstanciaParcial extends \AppBundle\Entity\InstanciaParcial implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nombre', 'descripcion', 'fechaInicio', 'fechaFin', '' . "\0" . 'AppBundle\\Entity\\InstanciaParcial' . "\0" . 'estado', 'alumnos', 'parcial');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InstanciaParcial $proxy) {
    ...
    public function setParcial(\AppBundle\Entity\Parcial $parcial = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setParcial', array($parcial));
    ...
    public function getParcial()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getParcial', array());
