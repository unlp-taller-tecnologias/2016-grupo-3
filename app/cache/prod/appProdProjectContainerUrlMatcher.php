    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/notas')) {
            ...
            if (rtrim($pathinfo, '/') === '/notas') {
                ...
                return array (  '_controller' => 'AppBundle\\Controller\\AlumnosParcialController::indexAction',  '_route' => 'notas_index',);
            }
            not_notas_index:

            // alumnosparcial_update
            if ($pathinfo === '/notas/update') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_alumnosparcial_update;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\AlumnosParcialController::updateAction',  '_route' => 'alumnosparcial_update',);
            }
            not_alumnosparcial_update:
            ...
            if ($pathinfo === '/notas/new') {
                ...
                return array (  '_controller' => 'AppBundle\\Controller\\AlumnosParcialController::newAction',  '_route' => 'notas_new',);
            }
            not_notas_new:
            ...
            if (preg_match('#^/notas/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'notas_show')), array (  '_controller' => 'AppBundle\\Controller\\AlumnosParcialController::showAction',));
            }
            not_notas_show:

            // notas_edit
            if (preg_match('#^/notas/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_notas_edit;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'notas_edit')), array (  '_controller' => 'AppBundle\\Controller\\AlumnosParcialController::editAction',));
            }
            not_notas_edit:
            ...
            if (preg_match('#^/notas/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'notas_delete')), array (  '_controller' => 'AppBundle\\Controller\\AlumnosParcialController::deleteAction',));
            }
            not_notas_delete:
        ...
        if (0 === strpos($pathinfo, '/c')) {
            ...
            if (0 === strpos($pathinfo, '/clase')) {
                ...
                // clase_update
                if ($pathinfo === '/clase/update') {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_clase_update;
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\ClaseController::updateAction',  '_route' => 'clase_update',);
                }
                not_clase_update:
            ...
            if (0 === strpos($pathinfo, '/comisiones')) {
                ...
                // buscar_alumno
                if ($pathinfo === '/comisiones/') {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_buscar_alumno;
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\ComisionesController::buscarAlumno',  '_route' => 'buscar_alumno',);
                }
                not_buscar_alumno:
        ...
        if (0 === strpos($pathinfo, '/instanciaparcial')) {
            ...
            // instanciaparcial_update
            if ($pathinfo === '/instanciaparcial/update') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_instanciaparcial_update;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\InstanciaParcialController::updateAction',  '_route' => 'instanciaparcial_update',);
            }
            not_instanciaparcial_update:
        ...
        if (0 === strpos($pathinfo, '/user')) {
            ...
            // user_edito
            if (preg_match('#^/user/(?P<id>[^/]++)/edito$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_user_edito;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_edito')), array (  '_controller' => 'AppBundle\\Controller\\UserController::editoAction',));
            }
            not_user_edito:
        ...
        if (0 === strpos($pathinfo, '/reporte')) {
            if (0 === strpos($pathinfo, '/reporteA')) {
                // reporteAlumno_index
                if (rtrim($pathinfo, '/') === '/reporteAlumno') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_reporteAlumno_index;
                    }

                    if (substr($pathinfo, -1) !== '/') {
                        return $this->redirect($pathinfo.'/', 'reporteAlumno_index');
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\reporteAlumnoController::indexAction',  '_route' => 'reporteAlumno_index',);
                }
                not_reporteAlumno_index:

                if (0 === strpos($pathinfo, '/reporteAsistencia')) {
                    ...
                    if ($pathinfo === '/reporteAsistencia/exportar/excelAsistencias') {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
                            goto not_exportarExcelAsistencias;
                        }

                        return array (  '_controller' => 'AppBundle\\Controller\\reporteAsistenciaController::exportarExcelAsistencias',  '_route' => 'exportarExcelAsistencias',);
                    }
                    not_exportarExcelAsistencias:

                }

            }

            if (0 === strpos($pathinfo, '/reporteNotas')) {
                // reporteNotas_index
                ...
                // exportarExcelNotas
                if ($pathinfo === '/reporteNotas/exportar/excelNotas') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_exportarExcelNotas;
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\reporteNotasController::exportarExcelNotas',  '_route' => 'exportarExcelNotas',);
                }
                not_exportarExcelNotas:
